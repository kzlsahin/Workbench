...
void dbspline(int npts, int k, int p1, float b[], float p[], float d1[], float d2[])
{
    ...
    */
    ...
    for (i1 = 1; i1 <= p1; i1++) {
        ...
        dbasis(k, t, npts, x, nbasis, d1nbasis, d2nbasis);      /* generate the basis function for this value of t */
        /*
                printf("t = %f \n",t);
                printf("nbasis = ");
                for (i = 1; i <= npts; i++){
...
/*
    ...
    Name: tdbspl.c
    Purpose: B-spline curve and derivative generator Chap3, Sec. 3.5
    Language: C
    Subroutines called: bspline.c
    Book reference:  Chapter 3, Sec. 3.12, Ex. 3.8, p. 88
*/
